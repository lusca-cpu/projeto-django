# Generated by Django 5.0.6 on 2024-09-19 17:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Concluído', 'Concluído'), ('Em andamento', 'Em andamento')], max_length=20)),
                ('data_upload', models.DateField(auto_now_add=True)),
                ('excel_file', models.FileField(upload_to='assessments/')),
                ('resultado', models.CharField(max_length=255)),
                ('meta', models.CharField(max_length=255)),
                ('upload_id', models.UUIDField(default=uuid.uuid4)),
                ('framework', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assessments', to='assessment.tipomodelo')),
            ],
        ),
    ]
